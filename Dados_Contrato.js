 ...
 * CORREÇÕES APLICADAS:
 * - CT 003/26: typo 'iid' → 'id' na medição 11
 * - CT 003/26: data '2027-12-15' → '2026-12-15'
 * - CT 048/25: medições 7 e 8 com datas idênticas corrigidas
 * - sumOfLatestMonthlyMeasurements: lógica implementada no adapter
 */
...
class ProjectDashboardAdapter {
    ...
    static processarContrato(contrato) {
        ...
        // Calcula a última medição com valor real (não nulo)
        ...
        return {
            ...
            ultimaMedicaoValor: ultimaMedicaoComValor ? ultimaMedicaoComValor.valor : 0
        };
    }
...
const rawProjects = [
    {
        ...
        medicoes: [
            ...
            { id: 11, dataInicio: "2026-02-11", dataFim: "2026-03-10", valor: null }
        ]
    },
    {
        id: "CT 068/25",
    ...
    },
    {
        ...
        cronogramas: [
            ...
            {
                nome: "Cronograma Prorrogação II",
                valoresAcumulados: [null, null, null, null, null, null, null, 1918166.99, 2172395.90, 2423619.18, 2664287.67, null]
            },
            {
    ...
    },
    {
        ...
        cronogramas: [
            {
                nome: "Previsto Inicial",
                valoresAcumulados: [61599.51, 117842.06, 174084.59, 912256.28, 1476109.60, 2304042.31, 2935659.62, 3329755.24, 3478407.85, 3685676.32, 3987453.53, 4418956.49, 4803370.83]
            }
        ],
        medicoes: [
    ...
    },
    {
        ...
        medicoes: [
            ...
            { id: 7,  dataInicio: "2026-01-07", dataFim: "2026-02-06", valor: null }, // CORRIGIDO: datas duplicadas removidas
            { id: 8,  dataInicio: "2026-02-07", dataFim: "2026-03-06", valor: null }, // CORRIGIDO
...
var projectData = rawProjects.map(p => {
    ...
    return {
        ...
        ultimaMedicaoValor: processado.ultimaMedicaoValor
    };
});
