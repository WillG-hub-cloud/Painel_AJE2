...
const projectData = [
    {
        ...
        grafico: {
            ...
            previstoDataSets: null // Exemplo: [{label: "Cronograma Inicial", data: [...]}, {label: "Cronograma Novo", data: [...]}]
        },
    ...
    },
    {
        ...
        medicoes: [
            ...
            { medicao: "1-5", inicio: '07/10/24', fim: '04/04/25', ref: 'Abr/25', valor: 893732.79, acumulado: 893732.79 },
            { medicao: 6, inicio: '05/04/25', fim: '04/05/25', ref: 'Mai/25', valor: 283688.17, acumulado: 1177420.96 },
            { medicao: 7, inicio: '07/05/25', fim: '05/06/25', ref: 'Jun/25', valor: 333302.47, acumulado: 1507373.86 },
            { medicao: 8, inicio: '06/06/25', fim: '05/07/25', ref: 'Jul/25', valor: 247651.60, acumulado: 1755025.46 },
            { medicao: 9, inicio: '06/07/25', fim: '04/08/25', ref: 'Ago/25', valor: 240338.24, acumulado: 1995363.70 },
            { medicao: 10, inicio: '05/08/25', fim: '03/09/25', ref: 'Set/25', valor: 161935.30, acumulado: 2157299.00 },
        ],
        grafico: {
            labels: ["Nov/24", "Dez/24", "Jan/25", "Fev/25", "Abr/25", "Mai/25", "Jun/25", "Jul/25", "Ago/25", "Set/25"],
            // Note o uso de 'previstoDataSets' para múltiplos cronogramas.
            previstoDataSets: [
